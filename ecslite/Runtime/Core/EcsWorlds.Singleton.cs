...
namespace Saro.Entities
{
    public partial class EcsWorld
    {
        ...
        public ref T GetSingleton<T>() where T : class, IEcsComponentSingleton, new()
        {
            ...
            return ref GetPool<T>(2, 2, 1).GetOrAddInternal(singletonID);
        }
        ...
        {
            var singletonID = GetSingletonEntity();
            return ref GetPoolUnmanaged<T>(2, 2, 1).GetOrAddInternal(singletonID);
        }
        ...
        private void InitDummyAndSingletonEntity()
        {
            // dummy
            var dummy = NewEntity();
            GetPoolUnmanaged<Dummy>(2, 2, 1).GetOrAddInternal(dummy);
